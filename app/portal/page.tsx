...
export default function PortalLoginPage() {
    ...
    async function check() {
      ...
      if (session) {
        ...
        if (member) {
          ...
          window.location.href = `/portal/member/${member.id}`
          return
        }
  ...
  return (
    <TexBg className="min-h-screen flex items-center justify-center p-4">
      <div style={{background:'white',borderRadius:14,padding:'28px 24px',width:'100%',maxWidth:320,textAlign:'center',fontFamily:'"Helvetica Neue",Helvetica,Arial,sans-serif'}}>
        {/* Logo */}
